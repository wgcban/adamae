...
_C.MODEL.MoViNetA0.deconv1= CN()
fill_conv(_C.MODEL.MoViNetA0.deconv1, 480,104,(1,3,3),(1,1,1),(0,1,1))

_C.MODEL.MoViNetA0.deconv2= CN()
fill_conv(_C.MODEL.MoViNetA0.deconv2, 104,56,(1,3,3),(1,1,1),(0,1,1))

_C.MODEL.MoViNetA0.deconv3= CN()
fill_conv(_C.MODEL.MoViNetA0.deconv3, 56,32,(1,3,3),(1,1,1),(0,1,1))

_C.MODEL.MoViNetA0.deconv4= CN()
fill_conv(_C.MODEL.MoViNetA0.deconv4, 32,8,(1,3,3),(1,1,1),(0,1,1))

_C.MODEL.MoViNetA0.deconv5= CN()
fill_conv(_C.MODEL.MoViNetA0.deconv5, 8,4,(1,3,3),(1,1,1),(0,1,1))
...
#block 5
fill_SE_config(_C.MODEL.MoViNetA2.blocks[3][0], 72 , 144, 480, (5,3,3), (1,1,1), (2,1,1), (0,1,1))
fill_SE_config(_C.MODEL.MoViNetA2.blocks[3][1], 144, 144, 384, (1,5,5), (1,1,1), (0,2,2), (0,1,1))
fill_SE_config(_C.MODEL.MoViNetA2.blocks[3][2], 144, 144, 384, (1,5,5), (1,1,1), (0,2,2), (0,1,1))
fill_SE_config(_C.MODEL.MoViNetA2.blocks[3][3], 144, 144, 480, (1,5,5), (1,1,1), (0,2,2), (0,1,1))
fill_SE_config(_C.MODEL.MoViNetA2.blocks[3][4], 144, 144, 480, (1,5,5), (1,1,1), (0,2,2), (0,1,1))
fill_SE_config(_C.MODEL.MoViNetA2.blocks[3][5], 144, 144, 480, (3,3,3), (1,1,1), (1,1,1), (0,1,1))
fill_SE_config(_C.MODEL.MoViNetA2.blocks[3][6], 144, 144, 576, (1,3,3), (1,1,1), (0,1,1), (0,1,1))

# fill_SE_config(_C.MODEL.MoViNetA2.blocks[3][0], 72, 144, 240, (5,3,3), (1,1,1), (2,1,1), (0,1,1))
# fill_SE_config(_C.MODEL.MoViNetA2.blocks[3][1], 144, 144, 240, (3,3,3), (1,1,1), (1,1,1), (0,1,1))
# fill_SE_config(_C.MODEL.MoViNetA2.blocks[3][2], 144, 144, 240, (3,3,3), (1,1,1), (1,1,1), (0,1,1))
# fill_SE_config(_C.MODEL.MoViNetA2.blocks[3][3], 144, 144, 240, (3,3,3), (1,1,1), (1,1,1), (0,1,1))
# fill_SE_config(_C.MODEL.MoViNetA2.blocks[3][4], 144, 144, 144, (1,5,5), (1,1,1), (0,2,2), (0,1,1))
# fill_SE_config(_C.MODEL.MoViNetA2.blocks[3][5], 144, 144, 240, (3,3,3), (1,1,1), (1,1,1), (0,1,1))
...
fill_conv(_C.MODEL.MoViNetA2.conv7, 144, 144, (2,1,1),(2,1,1),(0,0,0))

_C.MODEL.MoViNetA2.deconv1= CN()
fill_conv(_C.MODEL.MoViNetA2.deconv1, 640,144,(1,3,3),(1,1,1),(0,1,1))

_C.MODEL.MoViNetA2.deconv2= CN()
fill_conv(_C.MODEL.MoViNetA2.deconv2, 144,56,(1,3,3),(1,1,1),(0,1,1))

_C.MODEL.MoViNetA2.deconv3= CN()
fill_conv(_C.MODEL.MoViNetA2.deconv3, 56,32,(1,3,3),(1,1,1),(0,1,1))

_C.MODEL.MoViNetA2.deconv4= CN()
fill_conv(_C.MODEL.MoViNetA2.deconv4, 32,8,(1,3,3),(1,1,1),(0,1,1))

_C.MODEL.MoViNetA2.deconv5= CN()
fill_conv(_C.MODEL.MoViNetA2.deconv5, 8,1,(1,3,3),(1,1,1),(0,1,1))


_C.MODEL.MoViNetA2.conv2d1= CN()
fill_conv(_C.MODEL.MoViNetA2.conv2d1, 640,144,(3,3),(1,1),(1,1))

_C.MODEL.MoViNetA2.conv2d2= CN()
fill_conv(_C.MODEL.MoViNetA2.conv2d2, 144,56,(3,3),(1,1),(1,1))

_C.MODEL.MoViNetA2.conv2d3= CN()
fill_conv(_C.MODEL.MoViNetA2.conv2d3, 56,32,(3,3),(1,1),(1,1))

_C.MODEL.MoViNetA2.conv2d4= CN()
fill_conv(_C.MODEL.MoViNetA2.conv2d4, 32,8,(3,3),(1,1),(1,1))

_C.MODEL.MoViNetA2.conv2d5= CN()
fill_conv(_C.MODEL.MoViNetA2.conv2d5, 8,3,(3,3),(1,1),(1,1))

_C.MODEL.MoViNetA2.conv2d6= CN()
fill_conv(_C.MODEL.MoViNetA2.conv2d6, 3,1,(3,3),(1,1),(1,1))




# _C.MODEL.MoViNetA2.deconv6= CN()
# fill_conv(_C.MODEL.MoViNetA2.deconv6, 8,4,(1,3,3),(1,1,1),(0,1,1))
