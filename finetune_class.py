...
def main(args, ds_init):
    ...
    if ds_init is not None:
        msc.utils.create_ds_config(args)
    ...
    if args.model == "vit_base_patch16_224":
        ...
        patch_size = model.patch_size #patch_embed.patch_size
    ...
    if args.finetune:
        ...
        msc.utils.load_state_dict(model, checkpoint_model, prefix=args.model_prefix)
    ...
    total_batch_size = args.batch_size * args.update_freq * msc.utils.get_world_size()
